...
The re-cut epic shipped the typed follow-up review end to end (7 merges, PRs
#97–#103, v0.28.0→v0.33.0), added [[followup-decision-gate]] and
[[confirmation-authority]], and found the shipped card gate inert in production
...
Two follow-ups it filed (`FLLWUP-107`/`108`) stayed `Backlog`; a later **residual
run** (`/features-deliver EPIC-15`, 2026-09-23) delivered them plus
`FLLWUP-109/110/111` — 5 merges (PRs #107–#111) under run-scoped R-A/R-B
authorizations — and surfaced [[execution-mode-recording]] (a recorded mode
stricter than the runner executed HALTs the merge check). Witnesses:
[[2026-09-22-epic15-run-ledger]], [[2026-09-23-epic15-residual-run-ledger]].
...
[[2026-09-23-fllwup-backlog-cleanup]]. A second pass **grouped** the 41 survivors
into 7 thematic **close-out epics** (EPIC-16…22) by subsystem, re-homing the
cross-epic `epic: null` orphans so each epic is a runnable `/features-deliver`
scope. Witness: [[2026-09-23-fllwup-epic-grouping]].
...
- [[2026-09-23-fllwup-epic-grouping]] — the 7 thematic close-out epics (EPIC-16…22) grouping those follow-ups
