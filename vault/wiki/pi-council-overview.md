...
| v0.19.0 | **EPIC-9 release** — `package.json` 0.18.0 → 0.19.0; `v0.19.0` tagged and `latest` moved, carrying the accumulated EPIC-7/8/9 behavior changes under one release. ⚠️ **v0.18.0 was bumped in source but never tagged**, and `latest` had been pointing at the untagged 0.17.1 bump commit (`4074870`) | [[2026-09-16-epic9-run-ledger]] |
