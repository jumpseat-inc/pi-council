...
title: Preflight
type: concept
summary: The shell+script standard fixture that gates every council run — card-aware checks, MCP registration/auth, superpowers pin, openrouter auth; any FAIL: line halts startup.
...
starts**. The instructor runs it at `/council` step 0, and `features-deliver.md`
...
authorization assertion in v0.5.0.
...
- [[superpowers-dependency]], [[mcp-support]], [[council-loop]]
