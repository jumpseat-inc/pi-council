...
- [[deterministic-merge-check]] — The features-deliver merge gate: five mechanical criteria observed directly, keyed since EPIC-13 by the card's recorded execution mode (Direct = 1/2/5; no recorded mode = HALT), merged --match-head-commit, Done only after gates green on the merged SHA. EPIC-15 restored orchestrator-executed merges. EPIC-24 added three Deliberate merges (PRs #114–#116).
