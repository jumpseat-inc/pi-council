#!/usr/bin/env bash
# Council preflight for the EV-18 council fixture seed. Card-aware, no MCP,
# no origin fetch, no .pi presence gates — an eval scratch has none of those
# and the harness plays the human. Any FAIL: line must halt the run.
set -u
